...
This guide assumes you are using VeeValidate v3 with Nuxt2 and prefer not to migrate your Option API to the Composition API.

It's intended for developers who want to move to Nuxt3 with minimal effort.
...
Since the default rendering tag is `<form>`, there's no need to specify tag="form". (doc)

The failed prop has been deprecated, and an alternative is required.

[https://vee-validate.logaretm.com/v4/api/form/#:~:text=meta%3A%20FormMeta,inside%20the%20form](https://vee-validate.logaretm.com/v4/api/form/#:~:text=meta%3A%20FormMeta,inside%20the%20form)
